...
import (
	...
	"github.com/bantheus/ask-me-anything/internal/store/pgstore"
	...
	r.Route("/api", func(r chi.Router) {
		r.Route("/rooms", func(r chi.Router) {
			...
			r.Route("/{room_id}/messages", func(r chi.Router) {
				r.Post("/", a.handleCreateRommMessage)
...
func (h apiHandler) handleCreateRommMessage(w http.ResponseWriter, r *http.Request) {
	rawRoomId := chi.URLParam(r, "room_id")
	roomID, err := uuid.Parse(rawRoomId)
	if err != nil {
		http.Error(w, "invalid room id", http.StatusBadRequest)
	...
	go h.notifyClients(Message{Kind: MessageKindMessageCreated, RoomID: rawRoomId, Value: MessageMessageCreated{ID: messageID.String(), Message: body.Message}})
}
